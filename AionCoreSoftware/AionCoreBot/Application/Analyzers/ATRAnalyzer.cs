...
namespace AionCoreBot.Application.Analyzers
{
    public class ATRAnalyzer : IAnalyzer
    {
            ...
            IConfiguration configuration)
        {
            ...
            _changeFactorUpperThreshold = _configuration.GetValue<decimal>("IndicatorParameters:ATR:ChangeFactorUpperThreshold", 0.2m);
            _changeFactorIncrease = _configuration.GetValue<decimal>("IndicatorParameters:ATR:ChangeFactorIncrease", 1.1m);
            _changeFactorDecrease = _configuration.GetValue<decimal>("IndicatorParameters:ATR:ChangeFactorDecrease", 0.9m);

            _volumeRatioHigh = _configuration.GetValue<decimal>("IndicatorParameters:ATR:VolumeRatioHigh", 1.5m);
            _volumeFactorHigh = _configuration.GetValue<decimal>("IndicatorParameters:ATR:VolumeFactorHigh", 1.15m);
            _volumeRatioMedium = _configuration.GetValue<decimal>("IndicatorParameters:ATR:VolumeRatioMedium", 1.0m);
            _volumeFactorMedium = _configuration.GetValue<decimal>("IndicatorParameters:ATR:VolumeFactorMedium", 1.0m);
            _volumeRatioLow = _configuration.GetValue<decimal>("IndicatorParameters:ATR:VolumeRatioLow", 0.7m);
            _volumeFactorLow = _configuration.GetValue<decimal>("IndicatorParameters:ATR:VolumeFactorLow", 0.85m);
            _volumeFactorVeryLow = _configuration.GetValue<decimal>("IndicatorParameters:ATR:VolumeFactorVeryLow", 0.7m);
        }
