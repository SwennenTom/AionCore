...
namespace AionCoreBot.Application.Analysis.Analyzers
{
    public class RSIAnalyzer : IAnalyzer
    {
        ...
        {
            int period = _configuration.GetValue("IndicatorParameters:RSI:Period", 14);
            int overbought = _configuration.GetValue("IndicatorParameters:RSI:OverboughtThreshold", 70);
            int oversold = _configuration.GetValue("IndicatorParameters:RSI:OversoldThreshold", 30);
