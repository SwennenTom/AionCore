...
namespace AionCoreBot.Application.Analysis.Analyzers
{
    public class EMAAnalyzer : IAnalyzer
    {
        ...
        {
            int shortPeriod = _configuration.GetValue("IndicatorParameters:EMA:ShortPeriod", 7);
            int mediumPeriod = _configuration.GetValue("IndicatorParameters:EMA:MediumPeriod", 21);
        ...
        private async Task<decimal> CalculateConfidenceAsync(string symbol, string interval, DateTime evaluationTime, decimal shortEma, decimal mediumEma)
        {
            ...
            var upperLimit = _configuration.GetValue("IndicatorParameters:EMA:EMARatioUpperThreshold", 0.05m);
            var lowerThreshold = _configuration.GetValue("IndicatorParameters:EMA:EMARatioLowerThreshold", 0.005m);
            ...
            int longPeriod = _configuration.GetValue("IndicatorParameters:EMA:LongPeriod", 50);
